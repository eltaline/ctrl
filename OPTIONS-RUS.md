...
ipsallow
- **Описание:** Путь к файлу разрешенных IP адресов методов GET/POST для виртуального хоста. Если файл не указан, всегда будет отдаваться 403 ошибка.
- **Умолчание:** ""
- **Тип:** string
- **Секция:** [server.name]
...
vthreads
- **Описание:** Максимальное количество параллельных задач.
- **Умолчание:** 8
- **Значения:** 1-256
- **Тип:** int
- **Секция:** [server.name]
