...
vrepeaterr
- **Описание:** Задает по умолчанию парсинг ошибок при выполнении задач, можно указать несколько ошибок при которых заработают повторы выполнения задач.
- **Умолчание:**
- **Значения:**
- **Тип:** []string
- **Секция:** [server.name]
...
vreplace
- **Описание:** Задает по умолчанию перезапись одинаковой задачи в очереди received.
- **Умолчание:** false
- **Значения:** true/false
- **Тип:** bool
- **Секция:** [server.name]
