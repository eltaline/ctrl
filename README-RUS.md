...
- Ограничение одновременно запущенных задач из очереди на каждый виртуальный хост регулируется посредством параметра vthreads в конфигурационном файле сервера
...
- shell`s коды выхода доступны в поле stderr
